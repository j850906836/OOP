...
int main(){
	...
	cout<<"-----traverse c1-----"<<endl;
	traversal(c_result);		
	subtract(c1, c2, c1);			//在這裡就沒有規定順序，只要物品數量正確即可
	cout<<"-----traverse c2-----"<<endl;
	traversal(c1);										//c_result中要有1個"duck", 0個"goose", 0個"chicken"
